...
First, if you're using the default 'click' popup style, append the glossary styles to a new or existing CSS file.
...
And add the CSS file to `_quarto.yml`. 
...
Start each chapter with a setup chunk that sets the appropriate defaults for your project.
